  ...
  return (
    <section id="contact" className="relative py-20 sm:py-28 bg-white overflow-hidden">
      ...
      <Reveal className="max-w-4xl mx-auto px-2.5 sm:px-4 lg:px-5 xl:px-8 text-center relative">
        {/* Badge */}
        <div className="inline-flex items-center gap-2 bg-white border border-[#C0D2E5] text-[#1B65A6] text-[13px] font-semibold px-4 py-1.5 rounded-full mb-7 shadow-sm"
          style={{ fontFamily: "var(--font-dm)" }}>
          <span className="w-1.5 h-1.5 rounded-full bg-green-500 pulse-dot" />
          Ready to get started?
        </div>

        <h2 className="text-4xl sm:text-5xl lg:text-6xl font-extrabold text-[#0E1A28] tracking-tight leading-tight mb-5"
          style={{ fontFamily: "var(--font-syne)" }}>
          Ready to upgrade your
          <br />business communications?
        </h2>
        <p className="text-[#4A6278] text-[16.5px] sm:text-[17.5px] leading-relaxed mb-10 max-w-xl mx-auto"
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center">
          <a href="/contact"
            className="inline-flex items-center justify-center gap-2 bg-[#1B65A6] hover:bg-[#134d80] text-white font-bold px-8 py-4 rounded-xl transition-all text-[16.5px] shadow-md shadow-blue-200/60"
            style={{ fontFamily: "var(--font-dm)" }}>
            Schedule a Consultation
          </a>
          <a href="tel:8056582329"
            className="inline-flex items-center justify-center gap-2 bg-white border border-[#C0D2E5] hover:border-[#1B65A6] hover:text-[#1B65A6] text-[#3A5068] font-semibold px-8 py-4 rounded-xl transition-all text-[16.5px]"
            style={{ fontFamily: "var(--font-dm)" }}>
...
function FooterLabel({ children }: { children: React.ReactNode }) {
  return (
    <div className="text-[12px] font-bold uppercase tracking-[0.12em] text-white mb-5"
      style={{ fontFamily: "var(--font-dm)" }}>
      {children}
    </div>
  );
...
export function Footer() {
  return (
    <footer className="bg-[#071421] text-white">
      <div className="max-w-7xl mx-auto px-2.5 sm:px-4 lg:px-5 xl:px-20 py-16 sm:py-20">
        <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-12 gap-x-8 gap-y-12">
          ...
          <div className="col-span-2 sm:col-span-3 lg:col-span-4">
            ...
            <p className="text-[14.5px] text-[#9FB4C7] leading-relaxed mb-6 max-w-xs" style={{ fontFamily: "var(--font-dm)" }}>
            ...
            <div className="space-y-3">
              <a href="tel:8056582329"
                className="flex items-center gap-2.5 text-[15px] font-medium text-white hover:text-[#7EB8E8] transition-colors"
                style={{ fontFamily: "var(--font-dm)" }}>
              ...
              <a href="https://maps.google.com" target="_blank" rel="noopener noreferrer"
                className="flex items-center gap-2.5 text-[14.5px] text-[#9FB4C7] hover:text-[#7EB8E8] transition-colors"
                style={{ fontFamily: "var(--font-dm)" }}>
                <span className="w-8 h-8 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center flex-shrink-0 text-[#7EB8E8]">
            ...
            <div className="space-y-3">
              {companyLinks.map((l) => (
                <a key={l.label} href={l.href}
                  className="block text-[14.5px] text-[#9FB4C7] hover:text-[#7EB8E8] transition-colors"
                  style={{ fontFamily: "var(--font-dm)" }}>
                  {l.label}
                </a>
              ))}
          ...
          <div className="col-span-2 sm:col-span-1 lg:col-span-4">
            ...
            <div className="space-y-2.5">
              {hours.map((h) => (
                <div key={h.day} className="flex items-center justify-between text-[14.5px] pb-2.5 border-b border-white/[0.06] last:border-0 last:pb-0" style={{ fontFamily: "var(--font-dm)" }}>
      ...
      <div className="border-t border-white/[0.08]">
        <div className="max-w-7xl mx-auto px-2.5 sm:px-4 lg:px-5 xl:px-20 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p className="text-[13px] text-[#5C7A94]" style={{ fontFamily: "var(--font-dm)" }}>
            &copy; 2026 Atlantis Utility, INC. All Rights Reserved.
          </p>
          <div className="flex items-center gap-6 text-[13px] text-[#5C7A94]" style={{ fontFamily: "var(--font-dm)" }}>
