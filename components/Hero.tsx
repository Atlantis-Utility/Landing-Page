      ...
      <div className="relative z-10 max-w-7xl mx-auto px-2.5 sm:px-4 lg:px-5 xl:px-8 py-16 sm:py-24 w-full">
        ...
        >
          ...
          <motion.div variants={staggerItem}
            className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm border border-white/25 text-white text-[12px] font-semibold px-4 py-2 rounded-full mb-7 shadow-sm"
          ...
          <motion.h1 variants={staggerItem}
            className="text-[38px] sm:text-5xl lg:text-[58px] font-extrabold text-white leading-[1.06] tracking-[-0.02em] mb-5"
          ...
          <motion.p variants={staggerItem}
            className="text-white/80 text-[16px] sm:text-[17px] leading-relaxed mb-8 max-w-lg mx-auto lg:mx-0"
          ...
          <motion.div variants={staggerItem} className="flex flex-col sm:flex-row gap-3 justify-center lg:justify-start mb-10">
            <motion.a href="#contact"
              ...
              className="inline-flex items-center justify-center gap-2 bg-[#1B65A6] hover:bg-[#134d80] text-white font-semibold px-7 py-4 rounded-xl text-[15px] shadow-lg shadow-black/20"
              style={{ fontFamily: "var(--font-dm)" }}>
            ...
            <motion.a href="tel:8056582329"
              ...
              whileTap={{ scale: 0.97 }}
              transition={{ duration: 0.15 }}
              className="inline-flex items-center justify-center gap-2 bg-white/10 backdrop-blur-sm hover:bg-white/20 border border-white/25 text-white font-semibold px-7 py-4 rounded-xl text-[15px]"
              style={{ fontFamily: "var(--font-dm)" }}>
          ...
          <motion.div variants={staggerItem} className="grid grid-cols-2 sm:grid-cols-4 gap-3 lg:gap-4">
            {stats.map((s) => (
              <div key={s.label} className="bg-white/10 backdrop-blur-sm border border-white/15 rounded-2xl p-3 sm:p-4 text-center">
                <div className="text-[22px] sm:text-[24px] font-extrabold text-white leading-none mb-1"
                  style={{ fontFamily: "var(--font-syne)" }}>
                  <Counter value={s.value} />
                </div>
                <div className="text-[11px] text-white/70 font-medium" style={{ fontFamily: "var(--font-dm)" }}>
                  {s.label}
                </div>
              </div>
            ))}
