    ...
    <section className="relative pt-28 pb-16 bg-white overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-2.5 sm:px-4 lg:px-5 xl:px-8 relative">
        <Reveal>
          ...
          <h1 className="text-4xl sm:text-5xl lg:text-[53px] font-extrabold text-[#0E1A28] tracking-tight leading-[1.1] mb-4"
            style={{ fontFamily: "var(--font-syne)" }}>
            Terms and Conditions
          </h1>
          <p className="text-[#4A6278] text-[16.5px] leading-relaxed max-w-2xl"
