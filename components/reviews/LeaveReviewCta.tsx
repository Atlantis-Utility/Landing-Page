      ...
      <div className="max-w-7xl mx-auto px-2.5 sm:px-4 lg:px-5 xl:px-8">
        <Reveal className="card p-8 sm:p-10 bg-[#F5F8FC] flex flex-col sm:flex-row items-center justify-between gap-6 text-center sm:text-left">
          <div>
            ...
            <p className="text-[#4A6278] text-[16px] leading-relaxed max-w-md"
          ...
          <MotionLink href="/feedback"
            className="inline-flex items-center justify-center gap-2 bg-[#1B65A6] hover:bg-[#134d80] text-white font-semibold px-7 py-4 rounded-xl transition-all text-[16px] shadow-sm flex-shrink-0"
