      ...
      <section className="relative pt-28 pb-16 bg-white overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-2.5 sm:px-4 lg:px-5 xl:px-8 relative">
          ...
          <Reveal className="max-w-3xl">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-[59.5px] font-extrabold text-[#0E1A28] tracking-tight leading-[1.08] mb-6"
              style={{ fontFamily: "var(--font-syne)" }}>
              {city.headline}
            </h1>
            <p className="text-[#4A6278] text-[18px] leading-relaxed max-w-2xl mb-8"
