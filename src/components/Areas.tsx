      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12">
          ...
          <h2 className="text-3xl sm:text-4xl font-extrabold text-[#0E1A28] tracking-tight mb-4"
            ...
            Areas We Serve in<br />Ventura County and Beyond
          </h2>
          <p className="text-[#4A6278] text-[15px] leading-relaxed"
            style={{ fontFamily: "var(--font-dm)", fontWeight: 300 }}>
            We proudly serve Ventura County and nearby coastal and inland communities.
            Whether you are in Oxnard, Paso Robles, or Santa Barbara, we offer on-site
