const reasons = [
  {
    ...
    desc:  "Our team is based in Ventura County. No waiting weeks for a national vendor to show up.",
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-20 items-start">
          ...
          <div className="lg:sticky lg:top-28">
            ...
            <p className="text-[#4A6278] text-[15px] leading-relaxed mb-8"
              ...
              that knows Ventura County businesses and builds solutions that fit.
            </p>
